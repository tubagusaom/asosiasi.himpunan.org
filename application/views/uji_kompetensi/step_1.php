    ...
    <div class="row">
        <section class="panel panel-default">
            <div class="panel-body">
                <fieldset>
                    <legend>
                        <h3> MEMILIH KELOMPOK ASOSIASI</h3>
                        <h5>Pada bagian ini, silakan pilih salah satu kelompok asosiasi sesuai bidang.</h5>
                    </legend>
                </fieldset>
                ...
                <div class="row">
                    <div class="col-lg-12 col-xs-12">
                        ...
                        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                            <?php
                            foreach ($data_asosiasi as $key => $value) {
                                ...
                                <div class="panel panel-default" id="<?= $id_container; ?>">
                                    ...
                                    <div id="<?= $id_collapse ?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="<?= $id_heading ?>">
                                        <div class="panel-body">
                                            ...
                                            <a data-toggle="tooltip" data-placement="right" title="Pilih skema ini dan ke tahapan selanjutnya" href='#' class="nextBtn btn-sm btn-success" onclick='pilih_skema(<?php echo $value->id; ?>)' >PILIH ASOSIASI</a>
                                        </div>
                                    </div>
                                </div>
