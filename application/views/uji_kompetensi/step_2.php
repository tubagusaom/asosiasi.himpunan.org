...
<div class="col-xs-12 formStep2">
    <div class="col-md-12" style="margin-bottom: 20px;">
        ...
        <fieldset><legend><h3> FORMULIR PERMOHONAN</h3>
            <h5> Pada bagian ini lengkapi data yg berlaku saat ini. Untuk bagian yang bertanda (*) wajib diisi.</h5></legend></fieldset>

            <div class="col-md-3">
                <label class="control-label">UMKM <b class="harus_diisi">*</b></label>
            </div>

            <div class="col-md-9">
                <div class="form-group">
                    <select name="marketing" id="marketing" class="form-control">
                        <option value="1">INDUSTRI PERTANIAN & KEHUTANAN</option>
                        <option value="2">INDUSTI PETERNAKAN PERIKANAN & PENGOLAHAN MAKANAN</option>
                        <option value="3">INDUSTRI PERTAMBANGAN & ENERGIum</option>
                        <option value="4">INDUSTRI PENGELOLAAN KIMIA</option>
                        <option value="5">INDUSTRI PENGELOLAAN LOGAM & MESIN</option>
                        <option value="6">INDUSTRI PENGELOLAAN LAIN-LAIN</option>
                    </select>

                    <input type="hidden" id="step_langkah">
                </div>
            </div>
            ...
            <div class="col-md-9">
                ...
                <div class="col-md-3">
                    <label class="control-label">Nama Perusahaan <b class="harus_diisi">*</b> </label>
                </div>
                <div class="col-md-9">
                    <div class="form-group">
                        <input  maxlength="100" type="text" name="nama_lengkap" id="nama_lengkap" required class="form-control input-upper" placeholder="Masukkan Nama Perusahaan"  />
                      </div>
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="col-md-3">
                            <label class="control-label">Alamat Perusahaan <b class="harus_diisi">*</b></label>
                        </div>
                        <div class="col-md-9">
                            <div class="form-group">
                                <textarea name="alamat" id="alamat" class="form-control" required placeholder="Alamat Lengkap Perusahaan"> </textarea>
                        ...
                        <div class="col-md-3">
                            <label class="control-label">No Telp Perusahaan  <b class="harus_diisi">*</b> </label>
                        </div>
                        <div class="col-md-9">
                            <div class="form-group">
                                <input  maxlength="15" type="text" name="no_telp" id="no_telp" required class="form-control input-number" placeholder="Masukkan No Telp yang aktif"  />
        ...
        <div class="col-md-9">
            ...
            <div class="col-md-3">
                <label class="control-label">PIC Perusahaan <b class="harus_diisi">*</b> </label>
            </div>
            <div class="col-md-9">
                <div class="form-group">
                    <input  maxlength="100" type="text" name="perg_tinggi" id="perg_tinggi" required  class="form-control" placeholder="Masukkan Nama PIC"  />
                    <label id="label_perg_tinggi" style="font-size:10px;color: red;"></label>
                </div>
            </div>

            <div class="col-md-3">
                <label class="control-label">No. NIB<b class="harus_diisi">*</b></label>
            </div>
            <div class="col-md-9">
                <div class="form-group">
                    <input  maxlength="100" type="text" name="jurusan" id="jurusan" required class="form-control input-number"  placeholder="Masukkan No. NIB"  />
                    <label id="label_jurusan" style="font-size:10px;color: red;"></label>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <label class="control-label">No. NPWP<b class="harus_diisi">*</b></label>
            </div>
            <div class="col-md-9">
                <div class="form-group">
                    <input  maxlength="100" type="text" name="no_telp_company" id="no_telp_company" required  class="form-control input-number" placeholder="Masukkan No NPWP"  />
                    <label id="label_no_telp_company" style="font-size:10px;color: red;"></label>
                </div>
            </div>

            <div class="col-md-3">
                <label class="control-label">Asal Negara<b class="harus_diisi">*</b>  </label>
            </div>
            <div class="col-md-9">
                <div class="form-group">
                    <input  maxlength="100" type="text" name="kewarganegaraan" id="kewarganegaraan" required class="form-control input-upper" placeholder="Masukkan Asal Negara"  />
                    <label id="label_kewarganegaraan" style="font-size:10px;color: red;"></label>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <label class="control-label">Website<b class="harus_diisi">*</b></label>
            </div>
            <div class="col-md-9">
                <div class="form-group">
                  <input  maxlength="100" type="text" name="id_genre" id="id_genre" class="form-control" placeholder="Masukkan link URL website"  />
                  <label id="label_id_genre" style="font-size:10px;color: red;"></label>
                </div>
                <div style="margin-top:20px; margin-bottom:20px;">
                    <button id="selanjutnya-2" class="btn btn-success nextBtn btn-md pull-left btn-block" type="button" >Selanjutnya (Langkah 3)</button>
                </div>
            </div>
