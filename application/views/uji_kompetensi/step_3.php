<div class="col-md-12 formStep3">
    <fieldset><legend><h3> UPLOAD DOKUMEN PERSYARATAN</h3>
            <h5>Upload beberapa dokumen untuk bukti pemenuhan persyaratan.</h5></legend></fieldset>
    ...
    <div class="col-md-12" id="div_list_bukti_pendukung">
        ...
        <div class="col-md-6 col-xs-12" align="right">AD / ART <b class="harus_diisi">*</b> :</div>
        ...
        <div class="col-md-6 col-xs-12" align="right">SK Kemenkumham <b class="harus_diisi">*</b> :</div>
        ...
        <div class="col-md-6 col-xs-12" align="right">KTA Ketua Umum <b class="harus_diisi">*</b> :</div>
        ...
        <div class="col-md-6 col-xs-12" align="right">KTA Sekjen <b class="harus_diisi">*</b> :</div>
        ...
        <div class="col-md-6 col-xs-12" align="right">KTA Bendahara <b class="harus_diisi">*</b> :</div>
        ...
        <div class="col-md-12" style="margin-bottom: 20px;text-align: right;">
            ...
            <button id="selanjutnya-4" class="btn btn-success nextBtn btn-md pull-left btn-block" type="button" >Selesai dan Simpan</button>
        </div>
    </div>
