...
<div class="easyui-layout" data-options="fit:'true'">
        ...
        <div class="easyui-layout" data-options="fit:true, border: false">
            <div data-options="region:'west', border: false, fit: true" style="width: 30%;background-color: #fff;">
                <table border="0" cellpadding="0" cellspacing="0" style="margin: 0;">
                    <tr>
                        <td>
                            <a href=""><img src="<?php echo base_url() ?>assets/img/logo_transparent.png" style="width:70px;margin:0px; padding: 0px; margin-top: 5px;margin-left: 15px; float: left;border:0px;"/></a>
                        </td>
                    </tr>
                </table>
            </div>
    ...
    <div data-options="region:'south',split:true" style="height:50px;">
        <div class="x-form-copyright" style="bottom: 10px;"> &copy;2022 <?= $aplikasi->singkatan_unit ?>, Developed By <a href="http://aom.my.id" target="_blank">PMC</a> Team </div>
    </div>
