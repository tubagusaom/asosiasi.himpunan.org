...
class Permohonan_blanko extends MY_Controller {
	...
	$view = $this->load->view('permohonan_blanko/cetak_permohonan', $data, true);
        if ($type == "pdf" && $option == 'download') {
            ...
            $this->pdf->Output('/var/www/asosiasi-himpunan.org/assets/files/permohonan_blanko/'.'surat_permohonan_'. implode('_', $array_jadwal_id).'.pdf','F');
        }else{
            $this->load->library("htm12pdf");
            $this->htm12pdf->pdf_create($view, "pb-" . $id . ".pdf", false, true);
        }
	...
	function cetak_ba($id, $option = false, $type = "pdf") {
		...
		$view = $this->load->view('permohonan_blanko/cetak_ba', $data, true);
                if ($type == "pdf" && $option == 'download') {
                    ...
                    $this->pdf = new HTML2PDF('P','A4','en');
                    $this->pdf->WriteHTML($view);
                    $this->pdf->Output('/var/www/asosiasi-himpunan.org/assets/files/permohonan_blanko/'.'surat_beritaacara_'. implode('_', $array_jadwal_id).'.pdf','F');
                }else{
                    $this->load->library("htm12pdf");
                    $this->htm12pdf->pdf_create($view, "pb-" . $id . ".pdf", false, true);
                }
	...
	function cetak_keputusan($id, $option = false, $type = "pdf") {
        ...
        if ($type == "pdf" && $option == 'download') {
            ...
            $this->pdf = new HTML2PDF('P','A4','en');
            $this->pdf->WriteHTML($view);
            $this->pdf->Output('/var/www/asosiasi-himpunan.org/assets/files/permohonan_blanko/'.'surat_keputusan_'. implode('_', $array_jadwal_id).'.pdf','F');
        }else{
            $this->load->library("htm12pdf");
            $this->htm12pdf->pdf_create($view, "pb-" . $id . ".pdf", false, true);
        }
    ...
    function download($id){
    	...
    	$sp = '/var/www/asosiasi-himpunan.org/assets/files/permohonan_blanko/'.'surat_permohonan_'. implode('_', $array_jadwal_id).'.pdf';
    	$ba = '/var/www/asosiasi-himpunan.org/assets/files/permohonan_blanko/'.'surat_beritaacara_'. implode('_', $array_jadwal_id).'.pdf';
    	$keputusan = '/var/www/asosiasi-himpunan.org/assets/files/permohonan_blanko/'.'surat_keputusan_'. implode('_', $array_jadwal_id).'.pdf';
    	$excels = '/var/www/asosiasi-himpunan.org/assets/files/permohonan_blanko/'.'sertifikasi_'. implode('_', $array_jadwal_id).'.xls';
    ...
    function cetak($id, $option = false, $type = "pdf") {
        ...
        if ($type == "pdf") {
            ...
            //$this->pdf = new HTML2PDF('P','A4','en');
            //$this->pdf->WriteHTML($view);
            //$this->pdf->Output('/var/www/html/asosiasi-himpunan.org/assets/files/permohonan_blanko/'.'surat_keputusan_'.$jadwal_id.'.pdf','F');
        }
    }
}
